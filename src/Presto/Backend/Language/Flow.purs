...
instance showFlow :: Show (BackendFlowCommands next st rt s) where
  show (Ask _) ="Ask"
  show (Get _) = "Get"
  show (Put _ _) = "Put"
  show (Modify _ _) = "Modify"
  show (CallAPI _ _) ="CallAPI"
  show (DoAff _ _) = "DoAff"
  show (ThrowException _ _) = "ThrowException"
  show (FindOne _ _) = "FindOne"
  show (FindAll _ _) = "FindAll"
  show (Create  _ _) = "Create"
  show (FindOrCreate _ _) = "FindOrCreate"
  show (Query _ _) = "Query"
  show (Update _ _) = "Update"
  show (Delete _ _) = "Delete"
  show (GetDBConn _ _) = "GetDBConn"
  show (GetCacheConn _ _) = "GetCacheConn"
  show (Log _ _ _ ) = "Log"
  show (SetCache _ _ _ _) = "SetCache"
  show (SetCacheWithExpiry _ _ _ _ _) = "SetCacheWithExpiry"
  show (GetCache _ _ _) = "GetCache"
  show (KeyExistsCache _ _ _) = "KeyExistsCache"
  show (DelCache _ _ _) = "DelCache"
  show (Enqueue _ _ _ _) = "Enqueue"
  show (Dequeue _ _ _) = "Dequeue"
  show (GetQueueIdx _ _ _ _) = "GetQueueIdx"
  show (Fork _ _) = "Fork"
  show (Expire _ _ _ _) = "Expire"
  show (Incr _ _ _) = "Incr"
  show (SetHash _ _ _ _ _) = "SetHash"
  show (GetHashKey _ _ _ _) = "GetHashKey"
  show (PublishToChannel _ _ _ _) = "PublishToChannel"
  show (Subscribe _ _ _) ="Subscribe"
  show (SetMessageHandler _ _ _) = "SetMessageHandler"
  show (GetMulti _ _) ="GetMulti"
  show (SetCacheInMulti _ _ _ _) = "SetCacheInMulti"
  show (GetCacheInMulti _ _ _) = "GetCacheInMulti"
  show (DelCacheInMulti _ _ _) ="DelCacheInMulti"
  show (SetCacheWithExpiryInMulti _ _ _ _ _) = "SetCacheWithExpiryInMulti"
  show (ExpireInMulti _ _ _ _) ="ExpireInMulti"
  show (IncrInMulti _ _ _) ="IncrInMulti"
  show (SetHashInMulti _ _ _ _ _) ="SetHashInMulti"
  show (GetHashInMulti _ _ _ _) = "GetHashInMulti"
  show (PublishToChannelInMulti _ _ _ _) = "PublishToChannelInMulti"
  show (SubscribeInMulti _ _ _) ="SubscribeInMulti"
  show (EnqueueInMulti _ _ _ _) = "EnqueueInMulti"
  show (DequeueInMulti _ _ _) ="DequeueInMulti"
  show (GetQueueIdxInMulti _ _ _ _) = "GetQueueIdxInMulti"
  show (Exec _ _) ="Exec"
  show (RunSysCmd _ _) = "RunSysCmd"
